            ...
            <div id="teacher">
                ...
                ?>
                    ...
                    <div class="img-name-mail">
                        ...
                        <div class="n_m">
                            <span class="name"><?php echo $data['Fullname']; ?></span><br>
                            <span class="mail"><?php echo $data['Email']; ?></span>
                        </div>
                    </div>
                    <div class="about">
                        <h5>About</h5>
                        ...
                        <form action="">
                            <div class="top_post">  
                                <div class="title_date">
                                    ...
                                    -->
                                    <h4><?php echo $data['title']; ?><br/><span><?php echo time_elapsed_string($data['time']); ?></span></h4>
                                </div>
